...
```{r}
dat <- c(174,204,200,200,184,186,186,153,165,180,163,180,128,155,180, NA) / 10
...
ggplot(dat, aes("Självbefruktning", Längd)) + 
  geom_boxplot()
```

Storleken på intervallen i histogrammets x-axel kan styras med `binwidth`.
:::
