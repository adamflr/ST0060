...
paste0(dat$Smältpunkt, collapse = ", ")
```
...
::: {.hypothesis name="Uppgift 29 i övningskompendiet. Smältpunkt"}
...
b\. Funktionen `t.test` kan användas med nollhypotesens värde angiven med argumentet `mu`. Nollhypotesen är att populationsmedelvärdet $\mu$ är 8.42.
