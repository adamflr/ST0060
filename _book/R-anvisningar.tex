...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Vecka =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{7}\NormalTok{, }\DecValTok{11}\NormalTok{), }\AttributeTok{each =} \DecValTok{6}\NormalTok{),}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-27-1.pdf}

Utöver sannolikhetsberäkningar har R funktioner för att skapa slumptal från en angiven fördelning. Dessa genom av \texttt{r} följd av fördelningens namn, t.ex. \texttt{rnorm} för normalfördelningen och \texttt{rbinom} för binomialfördelningen. I exemplet nedan dras tiotusen observationer från en normalfördelning. Histogrammet visar att slumptalen ungefär följer den teoretiska fördelningen (här utritad med funktionen \texttt{stat\_function}).
...
\FunctionTok{ggplot}\NormalTok{(dat, }\FunctionTok{aes}\NormalTok{(x)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{..density..)) }\SpecialCharTok{+} \CommentTok{\# y = ..density.. anger att y{-}axeln ska vara i andelar}
  \FunctionTok{stat\_function}\NormalTok{(}\AttributeTok{fun =}\NormalTok{ dnorm, }\AttributeTok{args =} \FunctionTok{list}\NormalTok{(}\AttributeTok{mean =} \DecValTok{50}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{), }\AttributeTok{col =} \StringTok{"red"}\NormalTok{, }\AttributeTok{size =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-33-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{(dat, }\FunctionTok{aes}\NormalTok{(x)) }\SpecialCharTok{+}
  \FunctionTok{geom\_bar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Fördelningsfunktion), }\AttributeTok{stat =} \StringTok{"identity"}\NormalTok{, }
           \AttributeTok{fill =} \StringTok{"pink"}\NormalTok{, }\AttributeTok{col =} \StringTok{"hotpink"}\NormalTok{, }\AttributeTok{size =} \DecValTok{2}\NormalTok{, }\AttributeTok{width =} \FloatTok{0.5}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{xend =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ Sannolikhetsfunktion, }\AttributeTok{yend =} \DecValTok{0}\NormalTok{)) }\SpecialCharTok{+}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-38-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-46-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_segment}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{xend =}\NormalTok{ x, }\AttributeTok{y =} \DecValTok{0}\NormalTok{, }\AttributeTok{yend =}\NormalTok{Snlh), }\AttributeTok{data =}\NormalTok{ dat\_bin, }
               \AttributeTok{col =} \StringTok{"red"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}

\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-48-1.pdf}
...
Funktionen \texttt{rlnorm} skapar slumptal från en log-normal fördelning. Två separate grafer plottar histogram över slumptalen och slumptalen efter log-transform.
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-50-1.pdf}
\end{hypothesis}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-51-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-52-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-53-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-69-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-70-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-71-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-72-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-75-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-80-2.pdf}
\end{hypothesis}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-82-1.pdf}
\end{hypothesis}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-84-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-85-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-86-1.pdf}
...
\begin{solution}[Allsvenskan för herrar]
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-92-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-93-1.pdf}

Det verkar som att 1-1, följt av 2-1 och 1-0 är de vanligaste resultaten.
\end{solution}

\begin{exercise}[Väderstation Falsterbo]
SMHI publicerar historisk väderdata från en stor mängd väderstationer (). Ett exempel på en sådan fil, från väderstationen i Falsterbo, finns bland kursdatan. Notera att flera inledande rader innehåller metadata och inte ska läsas in. Filen är dessutom inte kommaseparerad utan semikolon-separerad. Den kan läsas in med funktionen \texttt{read\_csv2} från \texttt{readr}. Vid inläsning kan man också ändra datatyp för temperaturkolumnen, som annars felaktigt tolkats som en textkolumn.
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-96-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-98-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-102-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{(dat\_t, }\FunctionTok{aes}\NormalTok{(x, y)) }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymax =}\NormalTok{ y, }\AttributeTok{ymin =} \DecValTok{0}\NormalTok{), }\AttributeTok{fill =} \StringTok{"red3"}\NormalTok{, }
              \AttributeTok{data =}\NormalTok{ dat\_t }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(x }\SpecialCharTok{\textgreater{}}\NormalTok{ test\_results}\SpecialCharTok{$}\NormalTok{statistic)) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-104-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-108-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-113-1.pdf}
...
\begin{hypothesis}[Uppgift 29 i övningskompendiet. Smältpunkt]
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-116-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-121-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-123-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-126-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-127-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-132-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-135-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-139-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{Förekomst, dat}\SpecialCharTok{$}\NormalTok{Skadegrad)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-145-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(}\FunctionTok{table}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{Förekomst, dat}\SpecialCharTok{$}\NormalTok{Skadegrad))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{test\_result }\OtherTok{\textless{}{-}} \FunctionTok{chisq.test}\NormalTok{(}\FunctionTok{table}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{Förekomst, dat}\SpecialCharTok{$}\NormalTok{Skadegrad))}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-149-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-151-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-158-1.pdf}
\end{hypothesis}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-162-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-165-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-170-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-173-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-179-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-182-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-182-2.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-184-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-186-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-190-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-193-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-196-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-196-2.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-198-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-200-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-203-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-206-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-209-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-212-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-215-1.pdf}
...
\includegraphics{R-anvisningar_files/figure-latex/unnamed-chunk-216-1.pdf}
